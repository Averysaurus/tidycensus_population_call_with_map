...
# join with `load_variable` return to label varibles. 
...
There is a census tract in the ocean. Hover over it to find its designation and remove from API call results. 
...
- Note: interactive map objects can be finnicky in the markdown window, try pasting code into console to explore in R-studio viewer. 
